...
namespace SistemaVenta.DAL.DbVentaContext;

public partial class Dbventa2Context : DbContext
{
    public Dbventa2Context()
    {
    }

    public Dbventa2Context(DbContextOptions<Dbventa2Context> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240C6897B271");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843FD872B70D");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF48382D64EF7");
        ...
        {
            entity.HasKey(e => e.IdNegocio).HasName("PK__Negocio__70E1E1078A052611");
        ...
        {
            entity.HasKey(e => e.IdNumeroCorrelativo).HasName("PK__NumeroCo__25FB547E3614ED1A");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A132BF4BD36D");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F76C0B5A110");
        ...
        {
            entity.HasKey(e => e.IdRolMenu).HasName("PK__RolMenu__CD2045D82DF98030");
        ...
        {
            entity.HasKey(e => e.IdTipoDocumentoVenta).HasName("PK__TipoDocu__A9D59AEE88E90CA5");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A66D8C2241");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D561447BFC197");
