        ...
        fetch("/Usuario/Crear", {
            ...
            .then(responseJson => {
                if (responseJson.estado) {
                    ...
                    swal("Listo!", "El usuario fue creado exitosamente", "success")
                } else {
        ...
        fetch("/Usuario/Editar", {
            ...
            .then(responseJson => {
                if (responseJson.estado) {
                    ...
                    $("#modalData").modal("hide")
                    swal("Listo!", "El usuario fue editado exitosamente", "success")
                } else {
                    swal("Lo sentimos", responseJson.mensaje, "error")
                }
            })
                ...
                fetch(`/Usuario/Eliminar?IdUsuario=${data.idUsuario}`, {
                    ...
                    .then(responseJson => {
                        if (responseJson.estado) {
                            ...
                            $("#modalData").modal("hide")
                            swal("Listo!", "El usuario fue eliminado exitosamente", "success")
                        } else {
                            swal("Lo sentimos", responseJson.mensaje, "error")
                        }
                    })
