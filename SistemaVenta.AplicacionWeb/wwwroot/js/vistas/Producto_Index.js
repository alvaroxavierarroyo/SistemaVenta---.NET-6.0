        ...
        fetch("/Producto/Crear", {
            ...
            .then(responseJson => {
                if (responseJson.estado) {
                    ...
                    swal("Listo!", "El producto fue creado exitosamente", "success")
                } else {
        ...
        fetch("/Producto/Editar", {
            ...
            .then(responseJson => {
                if (responseJson.estado) {
                    ...
                    $("#modalData").modal("hide")
                    swal("Listo!", "El producto fue editado exitosamente", "success")
                } else {
                    swal("Lo sentimos", responseJson.mensaje, "error")
                }
            })
                ...
                fetch(`/Producto/Eliminar?IdProducto=${data.idProducto}`, {
                    ...
                    .then(responseJson => {
                        if (responseJson.estado) {
                            ...
                            $("#modalData").modal("hide")
                            swal("Listo!", "El producto fue eliminado exitosamente", "success")
                        } else {
                            swal("Lo sentimos", responseJson.mensaje, "error")
                        }
                    })
