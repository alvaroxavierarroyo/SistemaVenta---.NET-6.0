        ...
        fetch("/Categoria/Crear", {
            ...
            .then(responseJson => {
                if (responseJson.estado) {
                    ...
                    swal("Listo!", "La categoria fue creado exitosamente", "success")
                } else {
        ...
        fetch("Categoria/Editar", {
            ...
            .then(responseJson => {
                if (responseJson.estado) {
                    ...
                    $("#modalData").modal("hide")
                    swal("Listo!", "La categoria fue editada exitosamente", "success")
                } else {
                    swal("Lo sentimos", responseJson.mensaje, "error")
                }
            })
                ...
                fetch(`/Categoria/Eliminar?IdCategoria=${data.idCategoria}`, {
                    ...
                    .then(responseJson => {
                        if (responseJson.estado) {
                            ...
                            $("#modalData").modal("hide")
                            swal("Listo!", "La categoria fue eliminada exitosamente", "success")
                        } else {
                            swal("Lo sentimos", responseJson.mensaje, "error")
                        }
                    })
